...
class CreateSlotController extends GetxController {
  ...
  bool get hasDateSlots => dateAvailabilities.isNotEmpty;
  //--------------------------------------------------------
  /// INIT
  //--------------------------------------------------------
  @override
  void onInit() {
    ...
    doctorId = "1f05d2a0-7f38-4fd1-812d-176e711d3846";
  ...
  Future<void> fetchWeekAvailabilitiesForWeek(String weekId) async {
    await ApiService.request(
      endpoint:
          "availabilities/doctors/$doctorId/week?week_id=$weekId",
      method: Api.GET,
      onSuccess: (response) {
  ...
  /// DATE AVAILABILITIES
  //--------------------------------------------------------
  Future<void> fetchDateAvailabilities({
    ...
    await ApiService.request(
      endpoint:
          "availabilities/doctors/$doctorId/date?date=$date",
      method: Api.GET,
      onSuccess: (response) {
        if (response.statusCode == 200) {
